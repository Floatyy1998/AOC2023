...
public class Day16 {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Part 1: " + new Day16().solve(true, Helper.ReadTxTToArray.readLinesString("Day16/input.txt")));
        System.out.println("Part 2: " + new Day16().solve(false, Helper.ReadTxTToArray.readLinesString("Day16/input.txt")));
    }
