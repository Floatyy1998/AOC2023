...
public class Day17 {
    ...
    public static void main(String[] args) throws IOException {
        System.out.println(solve(true, Helper.ReadTxTToArray.readLinesString("Day17/input.txt")));
        System.out.println(solve(false, Helper.ReadTxTToArray.readLinesString("Day17/input.txt")));
    }
